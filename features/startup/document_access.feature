...
Scenario Outline: Access Document as Investor with access
  ...
  Examples:
  	...
  	|true  	    |entity_type=Startup  |name=Test | access_type=Document;access_to_investor_id=2;metadata=All          | approved=1 |
    ...
    |false      |entity_type=Startup  |name=Test | access_type=Document;access_to_category=Co-Investor;metadata=All   | approved=1 |
	  |false      |entity_type=Startup  |name=Test | access_type=Document;access_to_investor_id=2;metadata=All          | approved=0 |
