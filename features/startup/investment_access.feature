...
Scenario Outline: Access Investment as Investor with access
  ...
  Examples:
  	...
  	|true  	    |entity_type=Startup  |quantity=100 | access_type=Investment;access_to_investor_id=1;metadata=All          | approved=1 |
    ...
    |false      |entity_type=Startup  |quantity=120 | access_type=Investment;access_to_category=Co-Investor;metadata=All   | approved=1 |
	  |false      |entity_type=Startup  |quantity=100 | access_type=Investment;access_to_investor_id=1;metadata=All          | approved=0 |
