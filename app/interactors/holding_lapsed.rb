class HoldingLapsed
  ...
  def create_audit_trail(holding)
    ...
    context.audit_trail << HoldingAuditTrail.new(action: :holding_lapsed, owner: "Holding", quantity: holding.quantity, operation: :modify, ref: holding, entity_id: holding.entity_id, completed: true, parent_id: context.parent_id)
  end
