...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference("Scenario.count") do
      post scenarios_url, params: { scenario: { entity_id: @scenario.entity_id, name: @scenario.name } }
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { entity_id: @scenario.entity_id, name: @scenario.name } }
