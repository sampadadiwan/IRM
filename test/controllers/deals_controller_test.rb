...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference("Deal.count") do
      post deals_url, params: { deal: { amount: @deal.amount, entity_id: @deal.entity_id, name: @deal.name, status: @deal.status } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { amount: @deal.amount, entity_id: @deal.entity_id, name: @deal.name, status: @deal.status } }
