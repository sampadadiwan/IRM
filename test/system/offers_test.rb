...
class OffersTest < ApplicationSystemTestCase
  ...
  test "should create offer" do
    ...
    fill_in "Entity", with: @offer.entity_id
    fill_in "Notes", with: @offer.notes
    fill_in "Percentage", with: @offer.percentage
    fill_in "Quantity", with: @offer.quantity
    fill_in "Secondary sale", with: @offer.secondary_sale_id
